...
> el puerto 8009 (pasa al reiniciar el PC: la API vieja revive sin su
...
> ```
> NAMES                                 STATUS                    PORTS
> proyecto_paradigmas6-api-facturas-1   Up 2 hours                0.0.0.0:8009->8009/tcp
> proyecto_paradigmas6-postgres-1       Up 2 hours (healthy)      0.0.0.0:15438->5432/tcp
> ```
>
...
| Qué | Dónde |
|---|---|
| **EL FRONT** (lo que ve el usuario) | http://localhost:8015 |
| **API Facturas — Swagger** (probar los endpoints) | http://localhost:8009/docs |
| Diagnóstico | http://localhost:8009/ |
| PostgreSQL (para DBeaver/pgAdmin, opcional) | `localhost:15438` · `paradigmas`/`paradigmas123` |
...
http://localhost:8015, edite un producto, bórrele el nombre y oprima los
...
│
├── front_flask/                 # EL FRONT — Flask + Jinja2 (puerto 8015)
│   ├── Dockerfile               # Su PROPIA imagen: dos procesos, no uno
│   ├── app.py                   # Las vistas: 4 rutas GENÉRICAS + las de factura
│   ├── entidades.py             # v6: QUÉ tiene cada entidad, declarado UNA vez
...
│
├── api_facturas/                # LA API DE LA v1 — FastAPI (puerto 8009)
...
| [2_spec.md](docs/spec_kit/versiones/v6_front_completo/2_spec.md) | QUÉ construir y los **8 criterios de aceptación** |
| [3_plan.md](docs/spec_kit/versiones/v6_front_completo/3_plan.md) | CÓMO: el front declarativo, y por qué la factura no cabe |
| [4_research.md](docs/spec_kit/versiones/v6_front_completo/4_research.md) | Las decisiones: generalizar lo que se repite, no forzar lo que no |
| [5_data_model.md](docs/spec_kit/versiones/v6_front_completo/5_data_model.md) | **El front sigue sin datos propios** — y qué NO es `entidades.py` |
| [6_contracts.md](docs/spec_kit/versiones/v6_front_completo/6_contracts.md) | Las PANTALLAS de las seis entidades |
| [7_quickstart.md](docs/spec_kit/versiones/v6_front_completo/7_quickstart.md) | Arranque, smoke test y la regresión de la API v1–v4 |
| [8_tasks.md](docs/spec_kit/versiones/v6_front_completo/8_tasks.md) | Las 8 fases, cada una con su verificación |
| [9_checklist.md](docs/spec_kit/versiones/v6_front_completo/9_checklist.md) | **La compuerta 3**: se firma ANTES de programar |
| [GUIA_IA6.md](docs/spec_kit/versiones/v6_front_completo/GUIA_IA6.md) | Construir la versión con IA, con el prompt listo |
