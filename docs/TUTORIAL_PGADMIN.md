...
> Dato importante: la BD del contenedor publica el puerto **15438** en su PC
...
| Port | `15438` | El puerto publicado (no el 5432 clásico, para no chocar con un PostgreSQL local) |
...
Abra en el navegador: **http://localhost:8009/api/producto/PR001**
...
- pgAdmin se conecta al puerto **15438** (el publicado por el compose). Si no
