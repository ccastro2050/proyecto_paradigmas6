...
```
# API corriendo LOCAL (venv + uvicorn), la BD publica el puerto 15438 al host:
postgresql+asyncpg://paradigmas:paradigmas123@localhost:15438/bdfacturas_postgres_local
