...
| Archivo | Qué crece |
|---|---|
| `docker-compose.yml` | ★ `sqlserver` (2022, :11437, healthcheck con sqlcmd) + `sqlserver-init` + `DB_SQLSERVER` y el tercer valor de `DB_PROVIDER` |
...
- Puertos publicados: 8009 (API) · 15438 (postgres) · 13337 (mariadb) ·
  **11437 (sqlserver)**. Reconstrucción del estudiante: +100.
