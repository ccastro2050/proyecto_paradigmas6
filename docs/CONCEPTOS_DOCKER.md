...
flowchart LR
    ...
    NAV -.->|"opcional (diagnóstico):<br/>localhost:15438"| POSTGRES
    NAV -.->|"opcional (diagnóstico):<br/>localhost:13337"| MARIADB
    NAV -.->|"opcional (diagnóstico):<br/>localhost:11437"| SQLSERVER
```
